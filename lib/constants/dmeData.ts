...
export const DME_PROCESS_STEPS = [
  ...
  },
  {
    ...
    desc: 'Our clinical intake team and a licensed healthcare provider in your state review your submitted health details and verify your insurance coverage and eligibility details.',
  ...
  },
  {
    ...
    desc: 'Your eligibility, specific joint condition, and equipment coverage are evaluated according to established insurance guidelines.',
    iconName: 'FileCheck',

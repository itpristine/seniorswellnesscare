...
export const metadata: Metadata = {
  ...
  description:
    'Terms of service and patient agreements governing the use of Seniors Wellness Care website, eligibility pre-qualification tools, and diagnostic services.',
};

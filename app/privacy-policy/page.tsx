      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <Card className="p-8 sm:p-12 rounded-3xl bg-white border border-slate-200/90 shadow-xl space-y-6 text-sm text-slate-700 leading-relaxed">
          <section className="space-y-2">
            ...
            <p>
              {SITE_CONFIG.legalName} (&quot;Aegis Genomics&quot;, &quot;we&quot;, &quot;us&quot;) is dedicated to safeguarding your personal health information (PHI) and genomic data. We operate in strict compliance with the Health Insurance Portability and Accountability Act of 1996 (HIPAA), the Health Information Technology for Economic and Clinical Health Act (HITECH), and the Genetic Information Nondiscrimination Act of 2008 (GINA).
            </p>
          </section>

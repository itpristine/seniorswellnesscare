...
export const metadata: Metadata = {
  title: 'About seniors wellness care | Mission, Clinical Governance & Senior Care',
  description:
    'Learn about seniors wellness care—our mission to provide proactive senior healthcare through physician-ordered preventive genomics, Medicare-covered DME, and 24/7 medical alert systems.',
};

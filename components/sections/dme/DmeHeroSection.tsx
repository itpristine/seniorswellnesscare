      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-5 sm:space-y-6 text-left">
          ...
          <p className="font-sans-body text-sm sm:text-base md:text-lg text-slate-700 leading-relaxed max-w-2xl">
            Access medically necessary orthopedic braces for the back, knees, shoulders, wrists, and elbows. Eligible patients may qualify to receive supportive equipment through Medicare benefits with little to no out-of-pocket cost—complete with doctor review and free home delivery.
          </p>
          ...
          <div className="pt-4 flex flex-wrap items-center gap-3 sm:gap-6 text-[11px] sm:text-xs font-medium text-slate-600 border-t border-slate-200/80">
            ...
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4 text-[#0D9488] shrink-0" />
              <span>Free Doorstep Delivery &amp; Fit Support</span>
            </span>
          </div>
        </div>
          ...
          <div className="w-full max-w-md bg-white rounded-3xl p-6 sm:p-7 border border-slate-200/90 shadow-xl space-y-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  Takes under 2 minutes • No cost check
                </p>
              </div>
            ...
            <div className="p-3 rounded-xl bg-amber-50/70 border border-amber-200/80 text-xs text-slate-700 space-y-0.5">
              ...
              <p className="text-[11px] text-slate-600">
                If eligible and covered by your plan, out-of-pocket costs may be $0 with secondary insurance.
              </p>
            </div>

...
import { ShieldCheck, Award, Lock, FileCheck2, Building2 } from 'lucide-react';
  ...
  const credentials = [
    {
      ...
      subtitle: 'Federally certified partner laboratories',
    },
    {
      icon: <Award className="w-5 h-5 text-[#0D9488]" />,
      title: 'CAP-Accredited',
      subtitle: 'Highest pathology diagnostic accuracy',
    },
    {
      icon: <Lock className="w-5 h-5 text-emerald-600" />,
      title: 'HIPAA Compliant',
      subtitle: '256-bit encrypted health data privacy',
    },
    {
      icon: <FileCheck2 className="w-5 h-5 text-amber-600" />,
      title: 'Physician-Ordered',
      subtitle: 'State-licensed clinical medical review',
    },
    {
      icon: <ShieldCheck className="w-5 h-5 text-[#0D9488]" />,
      title: 'GINA Protected',
      subtitle: 'Federal genetic anti-discrimination law',
    },
  ];

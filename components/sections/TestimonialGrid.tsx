...
export function TestimonialGrid() {
  const testimonials = [
    ...
    },
    {
      id: 3,
      quote:
        'In my geriatric practice, polypharmacy is our biggest clinical hurdle. Having access to physician-ordered PGx and hereditary screening through Aegis Genomics without billing headaches allows my team to practice true precision medicine for our senior patients.',
